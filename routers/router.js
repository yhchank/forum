...
exports.showJavaScript = function (req, res, result) {
	if(req.session.loginUser != undefined) {
		res.render("JavaScript", { loginUser:req.session.loginUser });
	}else{
		res.render("JavaScript", { loginUser:'' });
	}
};
...
exports.showNodeJS = function (req, res, result) {
	if(req.session.loginUser != undefined) {
		res.render("NodeJS", { loginUser:req.session.loginUser });
	}else{
		res.render("NodeJS", { loginUser:'' });
	}
};
...
exports.showEnvironment = function (req, res, result) {
	if(req.session.loginUser != undefined) {
		res.render("Environment", { loginUser:req.session.loginUser });
	}else{
		res.render("Environment", { loginUser:'' });
	}
};
